...
@RestController
@RequestMapping("/api/ms-gateway-application-kafka")
public class MsGatewayApplicationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(MsGatewayApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MsGatewayApplicationKafkaResource(KafkaProperties kafkaProperties) {
