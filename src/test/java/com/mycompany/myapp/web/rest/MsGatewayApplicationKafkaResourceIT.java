...
class MsGatewayApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        MsGatewayApplicationKafkaResource kafkaResource = new MsGatewayApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/ms-gateway-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/ms-gateway-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
